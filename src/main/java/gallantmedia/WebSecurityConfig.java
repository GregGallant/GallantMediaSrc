...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    public void configure(WebSecurity web) throws Exception
    {
        web
                .ignoring()
                .antMatchers("/","/.well-known/pki-validation/**","/music","/contact", "/register","/news","/newsjson","/newslinks","/newssportsjson","/newsfashionjson","/newsentertainmentjson","/newsusjson","/newsus","/error","/resources/**","/supernews", "/newsorder")
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        http
            .authorizeRequests()
                .antMatchers("/","/.well-known/pki-validation/**","/music","/contact","/register","/news","/newsjson","/newslinks","/newssportsjson","/newsfashionjson","/newsentertainmentjson","/newsusjson","/newsus","/error","/resources/**","/supernews", "/newsorder").permitAll()
