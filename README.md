...
The 2018, first iteration of the news site was built in Java Spring Boot and Apache Tomcat and a deployment script I wrote in Python.  In my opinion, Java Spring has the best security framework which made it hard to migrate away from.  Much of the work was standard Bcrypt encryption Spring Security using Gradle for builds instead of maven and a vanilla / jQuery javascript frontend before moving to an older version of React.
<br/>
